...
urlpatterns = [
    ...
    path('create/basic-info/', views.create_player_basic_info, name='create_player_basic_info'),
    path('create/attributes-badges/', views.create_player_attributes_badges, name='create_player_attributes_badges'),
